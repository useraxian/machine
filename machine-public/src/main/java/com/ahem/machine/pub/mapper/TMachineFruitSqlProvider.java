...
import com.ahem.machine.pub.po.TMachineFruitExample.Criteria;
import com.ahem.machine.pub.po.TMachineFruitExample.Criterion;
...
public class TMachineFruitSqlProvider {
	...
	public String insertSelective(TMachineFruit record) {
		...
		if (record.getFruitMultiple() != null) {
			sql.VALUES("fruit_multiple", "#{fruitMultiple,jdbcType=INTEGER}");
		}
		return sql.toString();
	}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getFruitMultiple() != null) {
			sql.SET("fruit_multiple = #{record.fruitMultiple,jdbcType=INTEGER}");
		}
	...
	public String updateByPrimaryKeySelective(TMachineFruit record) {
		...
		if (record.getFruitMultiple() != null) {
			sql.SET("fruit_multiple = #{fruitMultiple,jdbcType=INTEGER}");
		}
