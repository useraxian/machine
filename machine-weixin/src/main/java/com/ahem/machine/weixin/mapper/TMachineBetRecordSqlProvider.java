...
public class TMachineBetRecordSqlProvider {
	 ...
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_machine_bet_record
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExampleSelective(Map<String, Object> parameter){TMachineBetRecord record=(TMachineBetRecord)parameter.get("record");TMachineBetRecordExample example=(TMachineBetRecordExample)parameter.get("example");SQL sql=new SQL();sql.UPDATE("t_machine_bet_record");if (record.getId() != null){sql.SET("id = #{record.id,jdbcType=INTEGER}");}if (record.getUserId() != null){sql.SET("user_id = #{record.userId,jdbcType=INTEGER}");}if (record.getRecordId() != null){sql.SET("record_id = #{record.recordId,jdbcType=INTEGER}");}if (record.getBetFruitId() != null){sql.SET("bet_fruit_id = #{record.betFruitId,jdbcType=INTEGER}");}if (record.getBetScore() != null){sql.SET("bet_score = #{record.betScore,jdbcType=INTEGER}");}if (record.getBetMultiple() != null){sql.SET("bet_multiple = #{record.betMultiple,jdbcType=INTEGER}");}if (record.getBetTime() != null){sql.SET("bet_time = #{record.betTime,jdbcType=TIMESTAMP}");}applyWhere(sql,example,true);return sql.toString();}

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_machine_bet_record
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExample(Map<String, Object> parameter){SQL sql=new SQL();sql.UPDATE("t_machine_bet_record");sql.SET("id = #{record.id,jdbcType=INTEGER}");sql.SET("user_id = #{record.userId,jdbcType=INTEGER}");sql.SET("record_id = #{record.recordId,jdbcType=INTEGER}");sql.SET("bet_fruit_id = #{record.betFruitId,jdbcType=INTEGER}");sql.SET("bet_score = #{record.betScore,jdbcType=INTEGER}");sql.SET("bet_multiple = #{record.betMultiple,jdbcType=INTEGER}");sql.SET("bet_time = #{record.betTime,jdbcType=TIMESTAMP}");TMachineBetRecordExample example=(TMachineBetRecordExample)parameter.get("example");applyWhere(sql,example,true);return sql.toString();}
