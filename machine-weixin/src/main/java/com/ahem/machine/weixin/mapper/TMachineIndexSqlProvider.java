...
public class TMachineIndexSqlProvider {
	 ...
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_machine_index
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExampleSelective(Map<String, Object> parameter){TMachineIndex record=(TMachineIndex)parameter.get("record");TMachineIndexExample example=(TMachineIndexExample)parameter.get("example");SQL sql=new SQL();sql.UPDATE("t_machine_index");if (record.getId() != null){sql.SET("id = #{record.id,jdbcType=INTEGER}");}if (record.getFruitId() != null){sql.SET("fruit_id = #{record.fruitId,jdbcType=INTEGER}");}applyWhere(sql,example,true);return sql.toString();}

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_machine_index
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExample(Map<String, Object> parameter){SQL sql=new SQL();sql.UPDATE("t_machine_index");sql.SET("id = #{record.id,jdbcType=INTEGER}");sql.SET("fruit_id = #{record.fruitId,jdbcType=INTEGER}");TMachineIndexExample example=(TMachineIndexExample)parameter.get("example");applyWhere(sql,example,true);return sql.toString();}
