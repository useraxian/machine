...
public class TWeixinUserSqlProvider {
	 ...
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_weixin_user
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExampleSelective(Map<String, Object> parameter){TWeixinUser record=(TWeixinUser)parameter.get("record");TWeixinUserExample example=(TWeixinUserExample)parameter.get("example");SQL sql=new SQL();sql.UPDATE("t_weixin_user");if (record.getOpenId() != null){sql.SET("open_id = #{record.openId,jdbcType=VARCHAR}");}if (record.getNickname() != null){sql.SET("nickname = #{record.nickname,jdbcType=VARCHAR}");}if (record.getLoginTime() != null){sql.SET("login_time = #{record.loginTime,jdbcType=TIMESTAMP}");}if (record.getSex() != null){sql.SET("sex = #{record.sex,jdbcType=INTEGER}");}if (record.getProvince() != null){sql.SET("province = #{record.province,jdbcType=VARCHAR}");}if (record.getCity() != null){sql.SET("city = #{record.city,jdbcType=VARCHAR}");}if (record.getCountry() != null){sql.SET("country = #{record.country,jdbcType=VARCHAR}");}if (record.getHeadimgurl() != null){sql.SET("headimgurl = #{record.headimgurl,jdbcType=VARCHAR}");}if (record.getPrivilege() != null){sql.SET("privilege = #{record.privilege,jdbcType=VARCHAR}");}applyWhere(sql,example,true);return sql.toString();}

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_weixin_user
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExample(Map<String, Object> parameter){SQL sql=new SQL();sql.UPDATE("t_weixin_user");sql.SET("open_id = #{record.openId,jdbcType=VARCHAR}");sql.SET("nickname = #{record.nickname,jdbcType=VARCHAR}");sql.SET("login_time = #{record.loginTime,jdbcType=TIMESTAMP}");sql.SET("sex = #{record.sex,jdbcType=INTEGER}");sql.SET("province = #{record.province,jdbcType=VARCHAR}");sql.SET("city = #{record.city,jdbcType=VARCHAR}");sql.SET("country = #{record.country,jdbcType=VARCHAR}");sql.SET("headimgurl = #{record.headimgurl,jdbcType=VARCHAR}");sql.SET("privilege = #{record.privilege,jdbcType=VARCHAR}");TWeixinUserExample example=(TWeixinUserExample)parameter.get("example");applyWhere(sql,example,true);return sql.toString();}
