...
public interface TMachineUserMapper {
     ...
     */
    @Insert({
        "insert into t_machine_user (id, user_name, ",
        "password, mobile_num, ",
        "weixin_open_id, create_time, ",
        "login_time, nickname)",
    ...
    @Select({
        "select",
        "id, user_name, password, mobile_num, weixin_open_id, create_time, login_time, ",
        "nickname",
        "from t_machine_user",
        "where id = #{id,jdbcType=INTEGER}"
    })
