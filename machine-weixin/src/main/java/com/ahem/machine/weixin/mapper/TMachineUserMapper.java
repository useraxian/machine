...
public interface TMachineUserMapper {
	...
	@Insert({ "insert into t_machine_user (id, user_name, ", "password, mobile_num, ", "weixin_open_id, create_time, ",
			"login_time, nickname)", "values (#{id,jdbcType=INTEGER}, #{userName,jdbcType=VARCHAR}, ",
			"#{password,jdbcType=VARCHAR}, #{mobileNum,jdbcType=INTEGER}, ",
			"#{weixinOpenId,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
			"#{loginTime,jdbcType=TIMESTAMP}, #{nickname,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Tue Mar 28 22:59:34 CST 2017
	 */
	@Select({ "select", "id, user_name, password, mobile_num, weixin_open_id, create_time, login_time, ", "nickname",
			"from t_machine_user", "where id = #{id,jdbcType=INTEGER}" })
	@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "user_name", property = "userName", jdbcType = JdbcType.VARCHAR),
			@Result(column = "password", property = "password", jdbcType = JdbcType.VARCHAR),
			@Result(column = "mobile_num", property = "mobileNum", jdbcType = JdbcType.INTEGER),
	...
	@Update({ "update t_machine_user", "set user_name = #{userName,jdbcType=VARCHAR},",
			...
			"login_time = #{loginTime,jdbcType=TIMESTAMP},", "nickname = #{nickname,jdbcType=VARCHAR}",
