...
public interface TMachineBetRecordMapper {
	...
	@Insert({ "insert into t_machine_bet_record (id, user_id, ", "record_id, bet_multiple, ",
			...
			"bet_score_6, bet_fruit_id_7, ", "bet_score_7, bet_result, ", "got_score)",
			...
			"#{betScore7,jdbcType=INTEGER}, #{betResult,jdbcType=INTEGER}, ", "#{gotScore,jdbcType=INTEGER})" })
	...
	@Select({ "select", "id, user_id, record_id, bet_multiple, bet_time, bet_fruit_id_1, bet_score_1, ",
			...
			"bet_result, got_score", "from t_machine_bet_record", "where id = #{id,jdbcType=INTEGER}" })
	@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "user_id", property = "userId", jdbcType = JdbcType.INTEGER),
			@Result(column = "record_id", property = "recordId", jdbcType = JdbcType.INTEGER),
			@Result(column = "bet_multiple", property = "betMultiple", jdbcType = JdbcType.INTEGER),
	...
	@Update({ "update t_machine_bet_record", "set user_id = #{userId,jdbcType=INTEGER},",
			...
			"bet_score_7 = #{betScore7,jdbcType=INTEGER},", "bet_result = #{betResult,jdbcType=INTEGER},",
			"got_score = #{gotScore,jdbcType=INTEGER}", "where id = #{id,jdbcType=INTEGER}" })
