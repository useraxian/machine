...
public class TMachineUserSqlProvider {
	 ...
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_machine_user
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExampleSelective(Map<String, Object> parameter){TMachineUser record=(TMachineUser)parameter.get("record");TMachineUserExample example=(TMachineUserExample)parameter.get("example");SQL sql=new SQL();sql.UPDATE("t_machine_user");if (record.getId() != null){sql.SET("id = #{record.id,jdbcType=INTEGER}");}if (record.getUserName() != null){sql.SET("user_name = #{record.userName,jdbcType=VARCHAR}");}if (record.getPassword() != null){sql.SET("password = #{record.password,jdbcType=VARCHAR}");}if (record.getMobileNum() != null){sql.SET("mobile_num = #{record.mobileNum,jdbcType=INTEGER}");}if (record.getWeixinOpenId() != null){sql.SET("weixin_open_id = #{record.weixinOpenId,jdbcType=VARCHAR}");}if (record.getCreateTime() != null){sql.SET("create_time = #{record.createTime,jdbcType=TIMESTAMP}");}if (record.getLoginTime() != null){sql.SET("login_time = #{record.loginTime,jdbcType=TIMESTAMP}");}if (record.getNickname() != null){sql.SET("nickname = #{record.nickname,jdbcType=VARCHAR}");}applyWhere(sql,example,true);return sql.toString();}

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table t_machine_user
	 * @mbg.generated  Tue Mar 28 14:55:19 CST 2017
	 */public String updateByExample(Map<String, Object> parameter){SQL sql=new SQL();sql.UPDATE("t_machine_user");sql.SET("id = #{record.id,jdbcType=INTEGER}");sql.SET("user_name = #{record.userName,jdbcType=VARCHAR}");sql.SET("password = #{record.password,jdbcType=VARCHAR}");sql.SET("mobile_num = #{record.mobileNum,jdbcType=INTEGER}");sql.SET("weixin_open_id = #{record.weixinOpenId,jdbcType=VARCHAR}");sql.SET("create_time = #{record.createTime,jdbcType=TIMESTAMP}");sql.SET("login_time = #{record.loginTime,jdbcType=TIMESTAMP}");sql.SET("nickname = #{record.nickname,jdbcType=VARCHAR}");TMachineUserExample example=(TMachineUserExample)parameter.get("example");applyWhere(sql,example,true);return sql.toString();}
